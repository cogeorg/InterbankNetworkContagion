...
if __name__ == '__main__':
	...
	for i in range(numBanks):
		...
		text = text + "    <parameter type='changing' name='pBank' value='" + "0.99" + "' validity='0-1000'></parameter>\n"
		text = text + "    <parameter type='changing' name='rhoBank' value='" + "0.08" + "' validity='0-1000'></parameter>\n"
